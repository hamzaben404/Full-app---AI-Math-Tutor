// components/math-coach/assistant-ui/attachment.tsx
"use client";
  ...
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        ...
        className="aui-attachment-tile-remove absolute right-1.5 top-1.5 size-3.5 rounded-full bg-white text-muted-foreground opacity-100 shadow-sm hover:!bg-white [&_svg]:text-black hover:[&_svg]:text-destructive"
        side="top"
      >
